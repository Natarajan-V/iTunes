...
mixin _$HomeState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<Tune> data) data,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<Tune> data)? data,
...
class _$HomeStateDataImpl implements _HomeStateData {
  const _$HomeStateDataImpl({required final List<Tune> data}) : _data = data;

  final List<Tune> _data;
  @override
  List<Tune> get data {
...
abstract class _HomeStateData implements HomeState {
  const factory _HomeStateData({required final List<Tune> data}) =
      _$HomeStateDataImpl;
...
class _$HomeStateEmptyImpl implements _HomeStateEmpty {
  const _$HomeStateEmptyImpl();
...
abstract class _HomeStateEmpty implements HomeState {
  const factory _HomeStateEmpty() = _$HomeStateEmptyImpl;
}
...
class _$HomeStateErrorImpl implements _HomeStateError {
  const _$HomeStateErrorImpl({this.e});
...
abstract class _HomeStateError implements HomeState {
  const factory _HomeStateError({final String? e}) = _$HomeStateErrorImpl;
