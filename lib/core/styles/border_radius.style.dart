...
const BorderRadius topOnly16 = BorderRadius.only(
  topLeft: Radius.circular(Dimen.margin),
  topRight: Radius.circular(Dimen.margin),
);

const BorderRadius topOnly32 = BorderRadius.only(
  topLeft: Radius.circular(Dimen.margin * 2),
  topRight: Radius.circular(Dimen.margin * 2),
);

const BorderRadius topOnly48 = BorderRadius.only(
  topLeft: Radius.circular(Dimen.margin * 3),
  topRight: Radius.circular(Dimen.margin * 3),
);

const BorderRadius rightOnly8 = BorderRadius.only(
  topRight: Radius.circular(Dimen.margin * .5),
  bottomRight: Radius.circular(Dimen.margin * .5),
);
